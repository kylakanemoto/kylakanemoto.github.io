...
In ICS 314, AI was very useful in prompt engineering, workflow optimization, and integrated testing. These were concepts that I had difficulty with in the beginning, but as I utilized AI to tackle these tasks, I became more familiar with them. Some tools that I found useful in this journey were ChatGPT, Claude, and Co-Pilot, and each had their strengths and weaknesses, which I will explain later. In short, AI has become an integral part of the software engineering scene, and it will keep evolving and perfecting its abilities well into the future.
...
For the in-class practice WODs, I found that using ChatGPT and Co-pilot helped me reach solutions more efficiently. Being under a time constraint while still learning the concepts and language was stressful, so AI made the process smoother. However, I tried to rely more on my knowledge alongside AI, since the practice WODs were done in groups and not graded assessments. I don't remember the exact prompts, but the basic structure I used was: *"Can you build a program based on (WOD-instructions)?"* In most cases, the program generated by AI was almost complete, requiring only minor tweaks. In some instances, especially for more complex WODs involving Bootstrap and React, I had to fix a majority of the code because ChatGPT or Co-pilot had misinterpreted my prompt. I found that these in-class practice WODs were great for my problem-solving skills, and learning through trial and error. It gave me a chance to get comfortable both with coding and using AI as a helper.

### In-class WODs

As for the in-class WODs, I relied on ChatGPT and Co-pilot a bit more due to the time pressure and stakes. Like the in-class practice WODs, my prompting approach was similar: *"Can you build a program based on (WOD-instructions)?"* Again, the program generated by AI required only minor adjustments, with the more complex WODs needing more. In the beginning, I felt that I was heavily using AI to write the code for the WODs. However, with more practice through the experience WODs and in-class practice WODs, I learned how to give clearer prompts and focus on the parts that mattered most. As a result, when it came to the more difficult WODs, I could quickly figure out which parts to tackle first, use the AI code as a starting point, and make precise adjustments. This helped me work faster and feel more confident, and it was satisfying to see how much I improved at problem-solving while still using AI as a helpful tool.
